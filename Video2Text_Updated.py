...
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QFileDialog, QLabel, QTextEdit, QStatusBar, QProgressBar, QMessageBox, QHBoxLayout
    ...
    def convert_audio_to_text(self):
        ...
        try:
            ...
            for chunk in chunk_files:
                ...
                self.update_text_output(" ".join(full_text))

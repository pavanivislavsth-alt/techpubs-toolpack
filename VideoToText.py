...
class VideoToTextApp(QWidget):
    ...
    def convert_audio_to_text(self):
        """ Convert uploaded video/audio file to text using Speech Recognition """
        ...
        try:
            ...
            QMessageBox.critical(self, "Error", "Google Speech Recognition could not understand the audio")
        except sr.RequestError as e:
            QMessageBox.critical(self, "Error", f"Could not request results from Google Speech Recognition service; {e}")

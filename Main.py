...
from PDFcompare import PDFComparisonTool
from Trademarkcheck import PDFSearcherApp
from SVG3converter import VisioToSVGConverter
from Registermanuals import RegisterManualApp
from video2ppt import VideoCapture
from PCKGdiagram import PackageDiagramSearchApp
...
class MainWindow(QWidget):
    ...
    def init_ui(self):
        ...
        <p><b>Note:</b> For optimal performance, use this tool with smaller PDF files that have similar page layouts. Large files or files with significantly different layouts may impact the accuracy and performance of the comparison.</p>
        <hr>
        """)
    ...
    # Original tool opening methods remain unchanged
